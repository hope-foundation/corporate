...
- ❌ **ห้ามใส่ที่อยู่สถานนมัสการหรือแผนที่ปักหมุด** — คริสตจักรนมัสการแบบสัญจร
  ที่อยู่เดียวที่อยู่บนหน้าเว็บได้คือสำนักงานใหญ่ของ **มูลนิธิ** ใน footer
  ซึ่งเป็นข้อมูลจดทะเบียน ไม่ใช่สถานที่ให้ใครไปนมัสการ (จงใจไม่ใส่ใน JSON-LD)
- ℹ️ บล็อก "นมัสการแบบสัญจร" ถูกถอดออกตามคำสั่งคริสตจักร ปุ่มโทรจึงหายไปด้วย
  เบอร์โทรยังอยู่ใน `src/data/site.ts` ถ้าจะเอาช่องทางติดต่อกลับมา
